...
```
* * * * * ubuntu bash /home/ubuntu/apps/pm_short/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test 
```
...
|--------|------|-----|-----|--------|--------|
|pm-short|tweet|`location`||||
|pm-short|facebook|`location`||||
|pm-short|email|`location`||||
|pm-short|new-comment||||
|pm-short|open-share-discuss||||
|pm-short|close-share-discuss||||
|pm-short|summary-copied||||
|pm-short|featured-tweet-action|`action`||``tweet_url``|
|pm-short|featured-facebook-action|`action`||``post_url``|
